            ...
            success: function(data) {
                ...
                Object.keys(dataFull).forEach(function(key){
                    $("#laptabel").append("<tr>"+
                                            ...
                                            "<td class='d-inline-flex gap-3 align-items-center justify-content-center'><button type='button' class='btn btn-success' onclick='edit("+key+")'><i class='fas fa-edit'></i>Edit</button>"+
